package com.example.abcwebview.widget.controller;
...
public class FormControllerManager {
    ...
    private static final String PACKAGE_PATH = "com.example.abcwebview.widget";
    ...
    public List<Long> getAllFormIdFromMap() {
        synchronized (controllerHashMap){
            return new ArrayList<>(controllerHashMap.keySet());
        }
    ...
    public boolean hasMoreForm(){
        synchronized (controllerHashMap){
            return controllerHashMap.size() > 0;
        }
